...
<div class="container form">
	<form class="form-signin" action="processor.php" method="post">
		...
		<label for="inputEmail" class="sr-only">Serial No.</label>
		<input type="text" id="Serial" name="serial_no" class="form-control" placeholder="Serial No." required autofocus>
